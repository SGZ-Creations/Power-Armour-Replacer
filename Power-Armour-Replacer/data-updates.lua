--compatibilities.recipes
	...
	require("compatibilities.recipes.updates.batteries_updates")
	require("compatibilities.recipes.updates.exolegs_updates")
	require("compatibilities.recipes.updates.fusion_updates")
	require("compatibilities.recipes.updates.immunity_updates")
	require("compatibilities.recipes.updates.lasers_updates")
	require("compatibilities.recipes.updates.nvgs_updates")
	require("compatibilities.recipes.updates.roboports_updates")
