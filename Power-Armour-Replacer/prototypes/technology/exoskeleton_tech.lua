...
data:extend({
    ...
    },
    {
        ...
        effects ={{type = "unlock-recipe", recipe = "par-exoskeleton-mk2"}},
        unit = {
            count = 1000,
            ingredients = {
    ...
    },
    {
        ...
        effects = {{ type = "unlock-recipe", recipe = "par-exoskeleton-mk3" }},
        unit = {
            count = 1500,
            ingredients = {
                { "automation-science-pack", 1},
    ...
    },
    {
        ...
        effects = {{type = "unlock-recipe", recipe = "par-exoskeleton-mk5"}},
        unit = {
            count = 2500,
            ingredients = {
                { "automation-science-pack", 1},
