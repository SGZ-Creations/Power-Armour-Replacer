local recipes = {
    {
        ...
        results = {{type="item", name="par-shock-defense-mk1", amount=1}}
    },
    {
        type = "recipe",
        ...
        results = {{type="item", name="par-shock-defense-mk2", amount=1}}
    },
    {
        type = "recipe",
        ...
        results = {{type="item", name="par-shock-defense-mk3", amount=1}}
    },
    {
        type = "recipe",
        ...
        results = {{type="item", name="par-shock-defense-mk4", amount=1}}
    },
    {
        type = "recipe",
    ...
    },
    {
        ...
        results = {{type="item", name="par-shock-defense-mk7", amount=1}}
    },
    {
        type = "recipe",
        ...
        results = {{type="item", name="par-shock-defense-mk8", amount=1}}
    },
    {
        type = "recipe",
        ...
        results = {{type="item", name="par-shock-defense-mk9", amount=1}}
    },
    {
        type = "recipe",
        ...
        results = {{type="item", name="par-shock-defense-mk10", amount=1}}
    },
}
data:extend(recipes)
