...
local power_armour = {
    ...
    { order = "afz", inventory_bonus = 300, grid_width = 60,  grid_height = 60,  weightvalue= SS["ArmourWeight_06"].value, durability= SS["ArmourDurability_06"].value, icon = "__Power-Armour-Replacer__/graphics/icons/armour/icon-power-armour-mk6.png", },
    { order = "agz", inventory_bonus = 350, grid_width = 70,  grid_height = 70,  weightvalue= SS["ArmourWeight_07"].value, durability= SS["ArmourDurability_07"].value, icon = "__Power-Armour-Replacer__/graphics/icons/armour/icon-power-armour-mk7.png", },
    { order = "ahz", inventory_bonus = 400, grid_width = 80,  grid_height = 80,  weightvalue= SS["ArmourWeight_08"].value, durability= SS["ArmourDurability_08"].value, icon = "__Power-Armour-Replacer__/graphics/icons/armour/icon-power-armour-mk7.png", }, --8
    { order = "aiz", inventory_bonus = 450, grid_width = 90,  grid_height = 90,  weightvalue= SS["ArmourWeight_09"].value, durability= SS["ArmourDurability_09"].value, icon = "__Power-Armour-Replacer__/graphics/icons/armour/icon-power-armour-mk7.png", }, --9
    { order = "ajz", inventory_bonus = 500, grid_width = 100, grid_height = 100, weightvalue= SS["ArmourWeight_10"].value, durability= SS["ArmourDurability_10"].value, icon = "__Power-Armour-Replacer__/graphics/icons/armour/icon-power-armour-mk7.png", }, --10
}
