...
local ShockDefence = {
	...
	{automatic =SS["ShockDefencePassiveActive_09"].value, shockpowerbuffer = tostring(SS["ShockPowerStorage_09"].value) .. "GJ", powerconsumption = tostring(SS["ShockPowerConsumption_09"].value) .. "GJ", damagemodifier = SS["ShockDamage_09"].value, ShootingCooldown = SS["ShockShootingSpeed_09"].value, --[[shockradius = SS["ShockDefenceRadius_09"].value,]] range = SS["ShockRange_09"].value, duration = SS["ShockDuration_09"].value,  knockback =SS["ShockKnockback_09"].value, weightvalue = SS["ShockWeight_09"].value, order = "gi[pasive-defense]-aa[armour-replacer]"},
	...
	local equipment = {
		...
		attack_parameters = {
			...
			ammo_type = {
				...
				action = {
					{type = "area", radius = 1, force = "enemy",
						action_delivery = {
							{type = "instant",
								target_effects = {
							...
							{type = "beam", beam = "electric-beam-no-sound", max_length = shock.range * 2, duration = shock.duration, --[[15,]] source_offset = {0, -0.5}, add_to_shooter = false}
						}
					}
				}
			}
