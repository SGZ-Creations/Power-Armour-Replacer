...
--[[
    local function QualityValue(tier)
        return mods["quality"] and (tier * 2) or 1
    end
]]
local roboports = {
    {charging_energy = tostring(SS["RoboportCharging_01"].value) .. "MW", buffer_capacity =tostring(SS["RoboportBuffer_01"].value) .. "MJ", input_flow_limit = tostring(SS["RoboportInputFlow_01"].value) .. "MW", construction_radius =SS["RoboportConstructionRadius_01"].value, robot_limit = SS["RoboportRobotLimit_01"].value, charging_station_count =SS["RoboportBotCharging_01"].value * QualityValue--[[(2)]], weightvalue = SS["RoboportWeight_01"].value, order = "ea[roboport]-aa[armour-replacer]", port_texture = icon_utils.create_equipment_icon("personal-roboport-1", 64, 1), port_sprite = icon_utils.create_equipment_sprite("personal-roboport-1", 128, 128,  1)},
    {charging_energy = tostring(SS["RoboportCharging_02"].value) .. "MW", buffer_capacity =tostring(SS["RoboportBuffer_02"].value) .. "MJ", input_flow_limit = tostring(SS["RoboportInputFlow_02"].value) .. "MW", construction_radius =SS["RoboportConstructionRadius_02"].value, robot_limit = SS["RoboportRobotLimit_02"].value, charging_station_count =SS["RoboportBotCharging_02"].value * QualityValue--[[(2)]], weightvalue = SS["RoboportWeight_02"].value, order = "eb[roboport]-aa[armour-replacer]", port_texture = icon_utils.create_equipment_icon("personal-roboport-1", 64, 2), port_sprite = icon_utils.create_equipment_sprite("personal-roboport-1", 128, 128,  2)},
    {charging_energy = tostring(SS["RoboportCharging_03"].value) .. "MW", buffer_capacity =tostring(SS["RoboportBuffer_03"].value) .. "MJ", input_flow_limit = tostring(SS["RoboportInputFlow_03"].value) .. "MW", construction_radius =SS["RoboportConstructionRadius_03"].value, robot_limit = SS["RoboportRobotLimit_03"].value, charging_station_count =SS["RoboportBotCharging_03"].value * QualityValue--[[(2)]], weightvalue = SS["RoboportWeight_03"].value, order = "ec[roboport]-aa[armour-replacer]", port_texture = icon_utils.create_equipment_icon("personal-roboport-1", 64, 3), port_sprite = icon_utils.create_equipment_sprite("personal-roboport-1", 128, 128,  3)},
    {charging_energy = tostring(SS["RoboportCharging_04"].value) .. "MW", buffer_capacity =tostring(SS["RoboportBuffer_04"].value) .. "MJ", input_flow_limit = tostring(SS["RoboportInputFlow_04"].value) .. "MW", construction_radius =SS["RoboportConstructionRadius_04"].value, robot_limit = SS["RoboportRobotLimit_04"].value, charging_station_count =SS["RoboportBotCharging_04"].value * QualityValue--[[(2)]], weightvalue = SS["RoboportWeight_04"].value, order = "ed[roboport]-aa[armour-replacer]", port_texture = icon_utils.create_equipment_icon("personal-roboport-1", 64, 4), port_sprite = icon_utils.create_equipment_sprite("personal-roboport-1", 128, 128,  4)},
    {charging_energy = tostring(SS["RoboportCharging_05"].value) .. "MW", buffer_capacity =tostring(SS["RoboportBuffer_05"].value) .. "MJ", input_flow_limit = tostring(SS["RoboportInputFlow_05"].value) .. "MW", construction_radius =SS["RoboportConstructionRadius_05"].value, robot_limit = SS["RoboportRobotLimit_05"].value, charging_station_count =SS["RoboportBotCharging_05"].value * QualityValue--[[(2)]], weightvalue = SS["RoboportWeight_05"].value, order = "ee[roboport]-aa[armour-replacer]", port_texture = icon_utils.create_equipment_icon("personal-roboport-1", 64, 5), port_sprite = icon_utils.create_equipment_sprite("personal-roboport-1", 128, 128,  5)},
    {charging_energy = tostring(SS["RoboportCharging_06"].value) .. "MW", buffer_capacity =tostring(SS["RoboportBuffer_06"].value) .. "MJ", input_flow_limit = tostring(SS["RoboportInputFlow_06"].value) .. "MW", construction_radius =SS["RoboportConstructionRadius_06"].value, robot_limit = SS["RoboportRobotLimit_06"].value, charging_station_count =SS["RoboportBotCharging_06"].value * QualityValue--[[(2)]], weightvalue = SS["RoboportWeight_06"].value, order = "ef[roboport]-aa[armour-replacer]", port_texture = icon_utils.create_equipment_icon("personal-roboport-2", 64, 6), port_sprite = icon_utils.create_equipment_sprite("personal-roboport-2", 128, 128,  6)},
    {charging_energy = tostring(SS["RoboportCharging_07"].value) .. "MW", buffer_capacity =tostring(SS["RoboportBuffer_07"].value) .. "MJ", input_flow_limit = tostring(SS["RoboportInputFlow_07"].value) .. "MW", construction_radius =SS["RoboportConstructionRadius_07"].value, robot_limit = SS["RoboportRobotLimit_07"].value, charging_station_count =SS["RoboportBotCharging_07"].value * QualityValue--[[(2)]], weightvalue = SS["RoboportWeight_07"].value, order = "eg[roboport]-aa[armour-replacer]", port_texture = icon_utils.create_equipment_icon("personal-roboport-2", 64, 7), port_sprite = icon_utils.create_equipment_sprite("personal-roboport-2", 128, 128,  7)},
    {charging_energy = tostring(SS["RoboportCharging_08"].value) .. "MW", buffer_capacity =tostring(SS["RoboportBuffer_08"].value) .. "MJ", input_flow_limit = tostring(SS["RoboportInputFlow_08"].value) .. "MW", construction_radius =SS["RoboportConstructionRadius_08"].value, robot_limit = SS["RoboportRobotLimit_08"].value, charging_station_count =SS["RoboportBotCharging_08"].value * QualityValue--[[(2)]], weightvalue = SS["RoboportWeight_08"].value, order = "eh[roboport]-aa[armour-replacer]", port_texture = icon_utils.create_equipment_icon("personal-roboport-2", 64, 8), port_sprite = icon_utils.create_equipment_sprite("personal-roboport-2", 128, 128,  8)},
    {charging_energy = tostring(SS["RoboportCharging_09"].value) .. "MW", buffer_capacity =tostring(SS["RoboportBuffer_09"].value) .. "MJ", input_flow_limit = tostring(SS["RoboportInputFlow_09"].value) .. "MW", construction_radius =SS["RoboportConstructionRadius_09"].value, robot_limit = SS["RoboportRobotLimit_09"].value, charging_station_count =SS["RoboportBotCharging_09"].value * QualityValue--[[(2)]], weightvalue = SS["RoboportWeight_09"].value, order = "ei[roboport]-aa[armour-replacer]", port_texture = icon_utils.create_equipment_icon("personal-roboport-2", 64, 9), port_sprite = icon_utils.create_equipment_sprite("personal-roboport-2", 128, 128,  9)},
    {charging_energy = tostring(SS["RoboportCharging_10"].value) .. "MW", buffer_capacity =tostring(SS["RoboportBuffer_10"].value) .. "MJ", input_flow_limit = tostring(SS["RoboportInputFlow_10"].value) .. "MW", construction_radius =SS["RoboportConstructionRadius_10"].value, robot_limit = SS["RoboportRobotLimit_10"].value, charging_station_count =SS["RoboportBotCharging_10"].value * QualityValue--[[(2)]], weightvalue = SS["RoboportWeight_10"].value, order = "ej[roboport]-aa[armour-replacer]", port_texture = icon_utils.create_equipment_icon("personal-roboport-2", 64, 10), port_sprite = icon_utils.create_equipment_sprite("personal-roboport-2", 128, 128, 10)},
}
