...
if mods["scrap-reprocessor"]then
	table.insert(Recipe["sr-electronic-scrap-processing"].results, {type = "item", name = "armour-control-unit", amount = SS["ArmourControlUnit"].value, probability = 0.075, show_details_in_recipe_tooltip = false})
end
